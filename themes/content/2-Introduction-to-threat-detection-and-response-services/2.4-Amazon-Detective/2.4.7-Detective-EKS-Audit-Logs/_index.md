...
1. Open the **Detective** console.  
   https://us-east-1.console.aws.amazon.com/detective/home?region=us-east-1#summary

2. From the navigation panel, under **Settings**, select **General**.

3. Click **Edit** next to **Optional source packages**.

![VPC](/images/2/2.4/2.4.7/s3.png)

4. Verify that the checkbox for **EKS audit logs** is selected.
